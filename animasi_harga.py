...
data = {
    ...
    "Harga": [
        "Rp18.262", "Rp18.261", "Rp18.158", "Rp18.231", "Rp18.042", "Rp17.953",  # <-- corrected typo
        "Rp18.254", "Rp18.254", "Rp17.977", "Rp18.002", "Rp17.878", "Rp18.187",
        "Rp18.255", "Rp17.923", "Rp18.107", "Rp18.015", "Rp17.981", "Rp17.824",  # <-- corrected typo
...
for i in range(0, len(df), 5):
    ...
    line_chart = alt.Chart(anim_df).mark_line(point=alt.OverlayMarkDef(color='red')).encode(
        x=alt.X('Tanggal:T', title='Tanggal', axis=alt.Axis(labelAngle=45)),
